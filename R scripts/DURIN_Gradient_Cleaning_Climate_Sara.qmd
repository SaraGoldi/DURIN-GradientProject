...
- Temperature and precipitation across space (coordinates)
...
- Temperature impact on leaf weight (by vegetation type)

- Temperature impact on plant height (by species), also as boxplot
...
# repeat test of a variation
#2 leaf_weight/temperature + hovedtype
...
#3 plant_height/temperature + species
...
#3b boxplot plant_height/temperature + species
(boxplot_height_temp <- ggplot(data = Gradient.df3) +
...
#2 one outlier, very high leaf weight!

#3 VM plants tend to be a bit taller than VV
